        ...
        <div className="max-w-[1400px] mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 reveal">
              <h1
                className="font-light leading-[1.05] tracking-tight mb-8 text-[#141414]"
                style={{ fontSize: "clamp(2.4rem,4.5vw,4.8rem)" }}
              >
                Экспертиза в проектировании
                <br />
                <span className="italic text-[#BFA37E]">
                  и реализации сложных форм.
                </span>
              </h1>
              <p
                className="font-light leading-relaxed text-black/50 max-w-[480px]"
                style={{ fontSize: "clamp(1rem,1.4vw,1.1rem)" }}
              >
                От концептуального эскиза до сложнейших инженерных расчётов и
                монтажа на объекте. На стыке искусства, технологий и
                архитектуры.
              </p>
            </div>
            ...
            <div
              className="lg:col-span-5 lg:col-start-8 reveal d2 relative py-8"
              id="intro-photo"
            >
              <img
                src="/assets/intro_kompetencii.png"
                alt="Пространственный объект"
                className="w-full h-auto block shadow-[0_40px_100px_rgba(20,20,20,0.13),0_8px_32px_rgba(20,20,20,0.08)]"
              />
            </div>
          </div>
        </div>
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid grid-cols-12 gap-6 mb-16 reveal">
              <div className="col-span-12 lg:col-span-5">
                <h2
                  className="font-light uppercase leading-none tracking-tight text-[#141414]"
              ...
              <div className="col-span-12 lg:col-span-5 lg:col-start-8 flex items-end">
                <p className="font-mono text-[11px] uppercase leading-relaxed text-black/40">
                  Студия работает с четырьмя ключевыми типами объектов. Каждый
                  проектируется для долгосрочной эксплуатации в городской или
                  коммерческой среде.
                </p>
              </div>
            </div>
                  ...
                  <div className="absolute inset-0 p-7 flex flex-col justify-end tc-content">
                    ...
                    <div className="tc-tags">
                      <div className="flex flex-wrap gap-1.5 mb-4">
                        <span className="px-2 py-0.5 border border-white/20 text-[9px] font-mono text-white/55 uppercase">
                          Urban
                        </span>
                        <span className="px-2 py-0.5 border border-white/20 text-[9px] font-mono text-white/55 uppercase">
                          Metal
              ...
              {[
                {
                  ...
                  subtitle:
                    "Художественное руководство и параметрическое проектирование",
                  content:
                    "Не просто рисуем — создаём математически выверенные формы. Работаем в Grasshopper и Rhino, формируем нарратив и технологическую стратегию. Параметрические модели контролируют геометрию, раскрой и сборку от первого эскиза до монтажа. Референс: AURORA | Festive Landmark project.",
                },
                {
                  title: "Advanced Engineering & Prototyping",
                  subtitle: "Инженерный расчёт и прототипирование 1:1",
                  content:
                    "Работаем с жёсткими допусками и ветровыми нагрузками. Создаём прототипы в масштабе 1:1 для объектов в общественных пространствах. Расчёт статических и динамических нагрузок, проектирование анкерных узлов и подвесных систем. Референс: FOREST CAMPUS | Swedish Global Retailer.",
                },
                {
                  title: "Инженерный расчёт",
                  subtitle: "Structural Engineering & Load Analysis",
                  content:
                    "Разработка конструктивных решений, расчёт статических и динамических нагрузок. Проектирование подвесных систем, тросовых конструкций и анкерных узлов для объектов любой геометрии.",
                },
                {
                ...
                },
                {
                  ...
                  content:
                    "Три собственных цеха — металл и каркасы, стеклопластик и смолы, покраска и чистовая сборка. За годы работы сформирована устойчивая партнёрская сеть из 12 специализированных фабрик, с которыми студия реализует проекты по единым стандартам качества.",
                },
                {
                  title: "Системная интеграция",
                  subtitle: "System Integration & Digital Infrastructure",
                  content:
                    "Объединение технологических подсистем в единую управляемую экосистему. Программирование логики работы медиа-фасадов, кинетических систем и световых инсталляций.",
                },
                {
                  title: "Городская интеграция и сопровождение",
                  subtitle: "Urban Integration & Technical Support",
                  content:
                    "Адаптация объектов к городской и ландшафтной среде. Авторский надзор, техническое обслуживание и долгосрочное сопровождение реализованных объектов.",
                },
              ].map((acc, index) => (
                <div
                  key={index}
                  className="acc-row reveal"
                  style={index === 6 ? { borderBottom: "none" } : {}}
                >
                  <div
                    className="grid grid-cols-12 gap-4 items-center py-7 px-2 cursor-pointer select-none"
                    onClick={() => toggleAcc(index)}
                  >
                    <div className="col-span-10 lg:col-span-5">
                      <h4 className="text-lg font-light uppercase tracking-tight text-[#141414]">
                        {acc.title}
                      </h4>
                    </div>
                    <div className="hidden lg:block lg:col-span-6 font-mono text-[10px] uppercase tracking-widest text-black/25">
                      {acc.subtitle}
                    </div>
                    <div className="col-span-2 lg:col-span-1 flex justify-end">
                      <span
                        className="acc-toggle material-symbols-outlined text-xl text-[#BFA37E]"
                        style={{
                          transform:
                            openAcc === index
                              ? "rotate(45deg)"
                  ...
                  <div
                    className="acc-body"
                    style={{ maxHeight: openAcc === index ? "500px" : "0px" }}
                  >
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end mb-16 reveal">
              <div className="lg:col-span-6">
                ...
                >
                  Полный цикл — от расчёта
                  <br />
                  до монтажа на объекте.
                </h2>
              </div>
              <div className="lg:col-span-5 lg:col-start-8">
                ...
                <p className="font-light leading-relaxed mt-6 text-[.95rem] text-black/45">
                  ...
                  Контроль качества на каждом этапе — в рамках единых стандартов
                  с сетью партнёрских производств.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-black/10">
              <div className="py-10 pr-10 border-b md:border-b-0 md:border-r border-black/10">
                <p className="font-mono text-[9px] uppercase tracking-[.3em] mb-6 text-black/30">
                  Metals
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <div className="w-1 h-1 flex-shrink-0 bg-[#BFA37E]"></div>
                    <span className="font-mono text-[10px] uppercase tracking-widest text-black/60">
                      Кортеновская сталь (Corten)
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-1 h-1 flex-shrink-0 bg-[#BFA37E]"></div>
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start reveal">
              <div className="lg:col-span-6">
                ...
                >
                  Проектируем по европейским стандартам.
                </h2>
                <p className="font-light leading-relaxed text-[.95rem] text-black/50 max-w-[480px]">
                  Все решения проектируются с учётом требований безопасности и
                  надёжности. Работаем в соответствии с международными
                  стандартами качества, адаптируем документацию под требования
                  локальных регуляторов — включая Eurocodes.
                </p>
              </div>
              <div className="lg:col-span-5 lg:col-start-8">
                <div className="space-y-0">
                  <div className="flex items-start gap-4 py-5 border-t border-black/10">
                    ...
                    <p className="font-mono text-[10px] uppercase tracking-widest leading-relaxed text-black/50">
                      Конструктивная безопасность и расчёт нагрузок
                    </p>
                  </div>
                  <div className="flex items-start gap-4 py-5 border-t border-black/10">
                    <div className="w-1 h-1 mt-2 flex-shrink-0 bg-[#BFA37E]"></div>
                    <p className="font-mono text-[10px] uppercase tracking-widest leading-relaxed text-black/50">
                      Документация под требования Eurocodes
                    </p>
                  </div>
                  <div className="flex items-start gap-4 py-5 border-t border-b border-black/10">
                    <div className="w-1 h-1 mt-2 flex-shrink-0 bg-[#BFA37E]"></div>
                    <p className="font-mono text-[10px] uppercase tracking-widest leading-relaxed text-black/50">
                      Адаптация под требования локальных регуляторов
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
              <div className="lg:col-span-7">
                ...
                <p className="font-light leading-relaxed mb-10 text-[1rem] text-black/45 max-w-[480px]">
                  Работаем с девелоперами, управляющими компаниями,
                  архитектурными бюро и городскими службами. Каждый проект
