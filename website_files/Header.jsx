  ...
  return (
    <>
      ...
      >
        <Link
          to="/"
          className="text-[1rem] font-normal tracking-[0.08em]  text-white font-display"
      ...
      >
        ...
        <nav className="flex flex-col gap-0">
          <Link
            to="/"
            className="font-display font-light text-2xl text-[#111] hover:text-[#BFA37E] no-underline py-[14px] border-b border-black/5 transition-colors"
          >
            Главная
          </Link>
          <Link
          ...
          <Link
            to="/contact"
            className="font-display font-light text-2xl text-[#111] hover:text-[#BFA37E] no-underline py-[14px] transition-colors"
          >
            Контакты
          </Link>
        </nav>
