    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 overflow-x-hidden">
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center">
        ...
        <div className="relative z-20 text-right px-6 md:px-12 max-w-4xl ml-auto pt-20">
          ...
          <p className="text-lg lg:text-xl text-white/90 max-w-xxl leading-relaxed mb-12 mt-4">
            16 лет создания постоянных и временных архитектурных конструкций. От
            технического света до монументальных форм.
          </p>
        ...
        <div className="flex flex-col md:flex-row border-y border-primary/20">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAGAdx3ehF7y0gAaYtnrWx_b-8_t3K_UkNMbYnHZQQW-gtbmGZftglyZ3GebqzeUVJa90OOx2QP_xgCZ0HWbXWaDyjr_arrL7NNoz3yeqSfJMOjUuFR5ZgR3p9fEdrF9WbJPAR7mM97Uyv-W55RFmuthsb1CLhUsWR2UItDqXqarSjFsHsL_WZBsLQFJ2CnG6SOq7cXA58iMDgzVmMxJ2s9moI9Xh3S6Ey_3eXl-G3_gFF8Gzjc5polQyI5ZnS_vtH5AYQghME9_Eeb')",
              }}
            ></div>
      ...
      <section className="px-6 md:px-12 py-24 bg-background-light dark:bg-background-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <Link
            to="/projects/011"
            className="md:col-span-4 mt-12 group cursor-pointer block"
          >
            <div className="aspect-[3/4] overflow-hidden mb-4">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuA80MRThVqC3YVgIyDl9IsVFpdu600EKOQhJndQTgYXoXDwW6jENlQYHDAUdmbUxutNhjegTYPqxfjm3gjLbydzmEKssQGAQxHkYYdIhC2QC3hYwZLuKNAzF9myYgJoIm4IHlraWMUPiI6LglCtyPtcf06_chlSYeONGkoLc8Ud9zZgUeecZhILn19m1c9xjovdjKCafOggER35nuWoOXQbYJYETxdtXQqFMpkEHuP2smZXeM5xriS1-XFTYS9l8GiUW5cTXyekxITJ')",
                }}
              ></div>
            </div>
            <div className="flex justify-between items-start">
          ...
          >
            <div className="aspect-square overflow-hidden mb-4">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCXkSqJWpXEKjKOWDQG8lecsnzd40ExKTdGfiPpg-N9TtKpcGvtlzSTYuGyaEXYjA8jdMl8p6jhRNw15ULv1xsfny9RM2YT5mstgOX-KHg5jICP7ZCJ_xRPGUX90cs5h-g5q4kn_FVL0o2NJY-mB3RamIipdKBtdOCsl3FsGxE5V68D3_HWx85lfNzdPajXy_Ke5-RjWnfZlacdmbLWfngblOybjCkDu3vPmLzdT7ojtm_lnpQRub_0eFA0BY87-Jasq47mtFc2LM5m')",
                }}
              ></div>
            </div>
            <div className="flex justify-between items-start">
      ...
      <section className="flex flex-col md:flex-row min-h-[600px] bg-background-dark">
        ...
        <div className="md:w-1/2 grid grid-cols-2 gap-1 p-1 bg-primary/20">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD1uzqlT1Sr4tVtX27b1DvLay-Px56xMBdxevn__-Hg_lGY-1CEInhzKd6X1nBxriS0xsx0nqAQYpvGLMFftJAfWXrylmap8zkT9Z1MkP6Wi5nCeNpsG_s0MfT7XQanB1PwvHuomuqy3BLLeSOs5vud_S0skwCiRohBoiofkSCzTdsXAegXcNmA5WYjZ-hXBXy5o5Lya9Emzjcr1_JT5j843IdljFh6jEkHK_ml37iHCEN7FYK7_3ynP1W3ZFIbts97TL-Y1ILWgRII')",
            }}
          ></div>
          <div
            className="bg-cover bg-center grayscale hover:grayscale-0 transition-all duration-700"
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAiIIwDbqr_CcrslusL86n9nQSOhqTqiMXIpT_Zy7Ln4UziNbaqL8tlFpdSHpXkqEm-hC092Epr58xOr0hP5AWbCSa28gAVxXKI9F5TKvInR-4-wfRjlLwdEnEwSNNd2wHso0vqd3h09YrqSKWDns0Jnp52q78bHBRgVRWIeBDMdr_uuc75q7tKE4BHFbSYmko-Nog6COG6v_oKdhVMdwUYEdwGOJB1IgEVMyuV3R-9WEaTAeo7Dw94xWqC6qi8EuA2mT0B7KvQ11aZ')",
            }}
          ></div>
        </div>
      </section>
